...
// export class PlayerArrowDownUpTrigger extends PlayerTrigger {
//     public register(whichPlayer: MapPlayer, _?: PlayerEvent, callback?: PlayerTriggerCallback) {
//         return super.register(whichPlayer, PlayerEvents.ARROW_DOWN_UP, callback)
//     }

//     public constructor(whichPlayer: MapPlayer, _?: PlayerEvent, callback?: PlayerTriggerCallback) {
//         super(whichPlayer, PlayerEvents.ARROW_DOWN_UP, callback)
//     }
// }