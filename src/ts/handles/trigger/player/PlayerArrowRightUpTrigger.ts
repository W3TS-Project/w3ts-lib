...
// export class PlayerArrowRightUpTrigger extends PlayerTrigger {
//     public register(whichPlayer: MapPlayer, _?: PlayerEvent, callback?: PlayerTriggerCallback) {
//         return super.register(whichPlayer, PlayerEvents.ARROW_RIGHT_UP, callback)
//     }

//     public constructor(whichPlayer: MapPlayer, _?: PlayerEvent, callback?: PlayerTriggerCallback) {
//         super(whichPlayer, PlayerEvents.ARROW_RIGHT_UP, callback)
//     }
// }