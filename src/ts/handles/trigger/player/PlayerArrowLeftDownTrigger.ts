...
// export class PlayerArrowLeftDownTrigger extends PlayerTrigger {
//     public register(whichPlayer: MapPlayer, _?: PlayerEvent, callback?: PlayerTriggerCallback) {
//         return super.register(whichPlayer, PlayerEvents.ARROW_LEFT_DOWN, callback)
//     }

//     public constructor(whichPlayer: MapPlayer, _?: PlayerEvent, callback?: PlayerTriggerCallback) {
//         super(whichPlayer, PlayerEvents.ARROW_LEFT_DOWN, callback)
//     }
// }
