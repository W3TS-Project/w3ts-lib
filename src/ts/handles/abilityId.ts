...
declare function BlzSetAbilityActivatedTooltip(abilCode: integer, tooltip: string, level: integer): void
declare function BlzSetAbilityExtendedTooltip(abilCode: integer, extendedTooltip: string, level: integer): void
declare function BlzSetAbilityActivatedExtendedTooltip(abilCode: integer, extendedTooltip: string, level: integer): void
declare function BlzSetAbilityResearchTooltip(abilCode: integer, researchTooltip: string, level: integer): void
declare function BlzSetAbilityResearchExtendedTooltip(abilCode: integer, researchExtendedTooltip: string, level: integer): void
...
export class AbilityId {
  ...
  public setTooltip(tooltip: string, level: integer) {
    BlzSetAbilityTooltip(this.id, tooltip, level)
    return this
  }

  public setActivatedTooltip(tooltip: string, level: integer) {
    BlzSetAbilityActivatedTooltip(this.id, tooltip, level)
    return this
  }

  public setExtendedTooltip(extendedTooltip: string, level: integer) {
    BlzSetAbilityExtendedTooltip(this.id, extendedTooltip, level)
    return this
  }

  public setActivatedExtendedTooltip(extendedTooltip: string, level: integer) {
    BlzSetAbilityActivatedExtendedTooltip(this.id, extendedTooltip, level)
    return this
  }

  public setResearchTooltip(researchTooltip: string, level: integer) {
    BlzSetAbilityResearchTooltip(this.id, researchTooltip, level)
    return this
  }

  public setResearchExtendedTooltip(researchExtendedTooltip: string, level: integer) {
    BlzSetAbilityResearchExtendedTooltip(this.id, researchExtendedTooltip, level)
    return this
  }
