...
export abstract class AbilityIntegerFields {
  ...
  public static readonly BUTTON_POSITION_ACTIVATED_X = new AbilityIntegerField(new RawCode('aubx'))
  public static readonly BUTTON_POSITION_ACTIVATED_Y = new AbilityIntegerField(new RawCode('auby'))
